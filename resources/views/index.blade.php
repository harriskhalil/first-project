                    ...
                    <div class="about-box-layout3">
                        ...
                        <form class="contact-form-box" id="contact-form-2">
                            <div class="row">
                                ...
                                <div class="col-12 form-group">
                                    <button type="submit" class="fw-btn-fill mg-t-10 bg-Primary text-textprimary">SUBMIT NOW<i class="fa fa-chevron-right"></i></button>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="about-box-layout4">
                        <div class="about-box-content">
                            ...
                            <a href="project1.html" class="ghost-btn-xl primary-border text-Primary mg-t-15">LEARN MORE<i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
