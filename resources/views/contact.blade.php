...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.25053" type="text/javascript"></script>
...
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.25053" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.25053" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.25053" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_feature.css?3.3.25053" />
<style type="text/css">
    .form-label-left{
        width:150px;
    }
...
<form class="jotform-form" action="/contact" method="POST">
    @csrf
...
{{--            </li>--}}
            <li class="form-line jf-required" data-type="control_email" >
                ...
                <div  class="form-input-wide jf-required">
                    <input type="text"  name="email" class="form-textbox validate[required, Email]" size="25" value="" placeholder=" " required="" />
                </div>
                @error('email')
                <div class="form-required" >{{$message}}</div>
                @enderror
                @if(session('message'))
                    {{session('message')}}
                    @endif
...
{{--            </li>--}}
    ...
    <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="211150279679461" />
    <script type="text/javascript">
        var all_spc = document.querySelectorAll("form[id='211150279679461'] .si" + "mple" + "_spc");
        for (var i = 0; i < all_spc.length; i++)
        {
            all_spc[i].value = "211150279679461-211150279679461";
        }
    </script>
    ...
    <div class="formFooter f6">
        <div class="formFooter-wrapper formFooter-leftSide">
            <a href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=211150279679461&utm_content=jotform_logo&utm_campaign=powered_by_jotform_le" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="https://cdn.jotfor.ms/assets/img/logo/logo-new@1x.png" alt="Jotform Logo"></a>
        </div>
        <div class="formFooter-wrapper formFooter-rightSide">
      <span class="formFooter-text">
        Now create your own JotForm - It's free!
      </span>
            <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=211150279679461&utm_content=jotform_button&utm_campaign=powered_by_jotform_le" target="_blank">Create your own JotForm</a>
        </div>
    </div>
</form>
